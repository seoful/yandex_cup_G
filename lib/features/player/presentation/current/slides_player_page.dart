...
class SlidesPlayerPage extends HookConsumerWidget {
  const SlidesPlayerPage({Key? key, required this.step}) : super(key: key);
          ...
          child: Padding(
            ...
            child: Row(
              ...
              children: [
                ...
                Text("${currentPage.value} of ${step.slides.length}"),
                TextButton(
                  onPressed: () {
                    if (currentPage.value == step.slides.length) {
                      ref.read(playerManagerProvider).nextStep();
                      return;
                    }
